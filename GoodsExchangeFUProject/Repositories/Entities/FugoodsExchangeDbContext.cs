...
public partial class GoodsExchangeFudbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.UserId, e.ProductId, e.RequesterId });
            ...
            entity.HasOne(d => d.Requester).WithMany(p => p.NotificationRequesters)
                .HasForeignKey(d => d.RequesterId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Notification_Requester");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK_Reset Token");
