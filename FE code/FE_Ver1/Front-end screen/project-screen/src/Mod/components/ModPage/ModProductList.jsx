...
const ModProductList = ({ currentPage, sortOrder, searchTerm, categoryId, setTotalPages, searchSubmitted, minPrice, maxPrice }) => {
  ...
  useEffect(() => {
    ...
    fetchProducts();
  }, [currentPage, sortOrder, term, category, setTotalPages, searchSubmitted, minPrice, maxPrice]);
